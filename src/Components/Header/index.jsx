      ...
      <div className="container">
        ...
        <div className="navigation">
          <ul>
            ...
            <NavLink className="nav-item" to="/Xizmatlar">
              Xizmatlar
            </NavLink>
            <NavLink className="nav-item" to="/price">
              Narxlar
            </NavLink>
            <NavLink className="nav-item" to="/works">
              Bizning ishlar
            </NavLink>
            ...
            <div className="nav-item">
              <div className={`language-dropdown ${isOpen ? "open" : ""}`}>
                <div className="selected-language" onClick={toggleDropdown}>
                  <img
                    src={selectedLanguage === "O'zbekcha" ? uzb : rus}
                    alt="Selected Flag"
                  />
                ...
                <div className="options">
                  <div
                    className="option"
                    onClick={() => selectLanguage("O'zbekcha")}
                  >
